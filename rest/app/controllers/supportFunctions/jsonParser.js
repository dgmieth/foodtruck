    ...
    arr[0].forEach(r => {
        if(r.cookingDateId!==ctrlId){
            ...
            cdArray.push({
                ...
                cookingStatus: r.cookingStatus===null ? 'Nao informada' : 
                                [1,2,3,4].includes(r.cookingStatusId) ? r.cookingStatus : 
                                arr[1].some(r1 => r1.cookingDateId===r.cookingDateId && [5,8,9,10,11].includes(r1.orderStatusId)) ? 'Pedido pago' : 
                                arr[1].some(r1 => r1.cookingDateId===r.cookingDateId && r1.orderStatusId === 3) ? 'Aceitando pagamentos' :
                                arr[1].some(r1 => r1.cookingDateId===r.cookingDateId && r1.orderStatusId === 4) ? 'Pedido na lista de espera' :
